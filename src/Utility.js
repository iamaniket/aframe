export const parts = ["Head", "Neck", "Rib", "Hand"];
export const bodyHeadings = [
  ...
  "In vertebrate anatomy, ribs (Latin: costae) are the long curved bones which form the rib cage, part of the axial skeleton",
